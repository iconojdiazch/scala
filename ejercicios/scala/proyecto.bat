...
echo. >> build1.sbt
echo libraryDependencies ++= Seq("ch.qos.logback" $ "logback-classic" $ "1.1.8","com.typesafe.akka" $$ "akka-slf4j" $ "2.4.16", "com.typesafe.akka" $$ "akka-actor" $ "2.4.16", "com.typesafe.akka" $$ "akka-stream" $ "2.4.16", "com.typesafe.akka" $$ "akka-testkit" $ "2.4.16" $ "test", "org.scalatest" $$ "scalatest" $ "3.0.1" $ "test") >> build1.sbt
echo. >> build1.sbt
